...
var MANIPULATE_AS_PROP = 2;
var MANIPULATE_AS_ATTR = 3;
var MANIPULATE_AS_PROP_AND_ATTR = 4;
...
var _updateElementAttribute = function _updateElementAttribute(namespace, element, attrName, newAttrValue, oldAttrValue) {
  ...
  if (manipulation === MANIPULATE_AS_PROP || manipulation === MANIPULATE_AS_PROP_AND_ATTR) {
    try {
  ...
  if (manipulation === MANIPULATE_AS_ATTR || manipulation === MANIPULATE_AS_PROP_AND_ATTR) {
