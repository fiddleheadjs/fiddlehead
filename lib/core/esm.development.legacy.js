...
var _updateElementAttribute = function _updateElementAttribute(namespace, element, attrName, newAttrValue, oldAttrValue) {
  ...
  var mayBe = _mayBePropertyOrAttribute(namespace, element, attrName, newAttrValue);
...
var _removeElementAttribute = function _removeElementAttribute(namespace, element, attrName, oldAttrValue) {
  ...
  var mayBe = _mayBePropertyOrAttribute(namespace, element, attrName, oldAttrValue);
...
var _mayBePropertyOrAttribute = function _mayBePropertyOrAttribute(namespace, element, attrName, attrValue) {
