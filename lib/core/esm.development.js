        ...
        while (hook !== null) {
            if (hook.tag_ === STATE_ERROR) {
                hook.setValue_((prevError) => {
                    if (prevError != null) { // not nullish
                        return prevError;
                    }
                    if (error != null) { // not nullish
                        return error;
                    }
                    return null;
                });
...
export { Fragment, TextNode, createElement, createPortal, createRef, createElement as jsx, render, resolveRootVNode, useCatch, useEffect, useLayoutEffect, useRef, useState };
