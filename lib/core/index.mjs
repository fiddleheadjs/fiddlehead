...
export let Text = isProd ? Text_prod : Text_dev;
...
export let useCatch = isProd ? useCatch_prod : useCatch_dev;
...
export let useCallback = isProd ? useCallback_prod : useCallback_dev;
export let useMemo = isProd ? useMemo_prod : useMemo_dev;
export let useTreeId = isProd ? useTreeId_prod : useTreeId_dev;
