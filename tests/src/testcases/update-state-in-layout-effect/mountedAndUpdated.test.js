...
describe('mountedAndUpdated.test.js', () => {
    ...
    it('Layout effect called once when dependency param was an empty array',async () => {
        //useLayoutEffect has dependency is empty array
        ...
        //useLayoutEffect has dependency is variables
    ...
    it('Layout effect did not call when object param in dependency changed', async () => {
    ...
    it('Layout effect called when dependency changed',async () => {
        stateMock = {a: 3};
        getMockValue.mockReturnValue(stateMock);
